...
void protobuf_AssignDesc_light_5fbuoy_5fcolors_2eproto() {
  ...
  LightBuoyColors_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(LightBuoyColors, _unknown_fields_),
      -1,
...
LightBuoyColors* LightBuoyColors::New() const {
  return new LightBuoyColors;
}
...
::google::protobuf::uint8* LightBuoyColors::SerializeWithCachedSizesToArray(
...
void LightBuoyColors::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const LightBuoyColors* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const LightBuoyColors*>(
      &from);
  if (source == NULL) {
...
void LightBuoyColors::MergeFrom(const LightBuoyColors& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_color_1()) {
      set_color_1(from.color_1());
    }
    if (from.has_color_2()) {
      set_color_2(from.color_2());
    }
    if (from.has_color_3()) {
      set_color_3(from.color_3());
    }
  }
...
void LightBuoyColors::Swap(LightBuoyColors* other) {
  if (other != this) {
    std::swap(color_1_, other->color_1_);
    std::swap(color_2_, other->color_2_);
    std::swap(color_3_, other->color_3_);
